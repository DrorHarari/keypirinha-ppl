...
class VcfFile(object):
    ...
    def load_vcard_file(self):
        self.info(f"Loading contacts file {self.filename}")
...
# vcf = VcfFile(r"C:\Util\Keypirinha\portable\Profile\User\google.vcf")
# vcf.load_vcard_file()
# for c in vcf.contacts:
    # print(c)

if False:
    with open(r"C:\Util\Keypirinha\portable\Profile\User\google.vcf", "r", encoding='utf-8') as inf:
        indata = inf.read()
